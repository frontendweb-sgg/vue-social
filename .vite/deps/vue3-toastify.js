...
function Me(e) {
  var E
  const { position: t, containerClassName: n, rtl: a = false, style: o = {} } = e,
    s = r.CSS_NAMESPACE,
    d = Be(t),
    T = document.querySelector('.'.concat(s)),
    u = document.querySelector('.'.concat(d)),
    N = !!u && !((E = u.className) != null && E.includes(K)),
    m = T || document.createElement('div'),
    S = document.createElement('div')
  ;(S.className = qe(t, n, a)),
    (S.dataset.testid = ''.concat(r.CSS_NAMESPACE, '__toast-container--').concat(t)),
    (S.id = Le(e))
  for (const v in o)
  ...
  return (
    T || ((m.className = r.CSS_NAMESPACE), document.body.appendChild(m)), N || m.appendChild(S), S
  )
}
function ee(e) {
  var a, o, s
  const t =
      typeof e == 'string'
        ? e
        : ((a = e.currentTarget) == null ? void 0 : a.id) ||
          ((o = e.target) == null ? void 0 : o.id),
...
function te(e, t = true) {
  ...
  a && a.classList.add(K),
    t ? (Re(e), a && a.addEventListener('animationend', ee, false)) : ee(n),
    (_.items = _.items.filter((o) => o.containerId !== e))
}
function Fe(e) {
...
function ne(e, t = {}) {
  ...
  o && !t.updateId && (t.position = a[0].position),
    nextTick(() => {
...
var C = {
  ...
  add(e, t) {
    ...
    n &&
      ((c[n] = c[n] || []),
      c[n].find((a) => a.toastId === t.toastId) ||
        setTimeout(() => {
          var a, o
          t.newestOnTop ? (a = c[n]) == null || a.unshift(t) : (o = c[n]) == null || o.push(t),
            t.onOpen && t.onOpen(ie(t))
        }, t.delay || 0))
  },
  /**
   * remove a toast
  ...
  remove(e) {
    if (e) {
      ...
      if (t) {
        ...
        ;(c[t] = n.filter((o) => o.toastId !== e)),
          !c[t].length && !De(t) && te(t, false),
          ke(),
          nextTick(() => {
  ...
  update(e = {}) {
    ...
    if (t && e.updateId) {
      ...
      const n = c[t].find((s) => s.toastId === e.toastId),
        ...
        o = { ...e, disabledEnterTransition: !a, updateId: void 0 }
      C.dismissForce(e == null ? void 0 : e.toastId),
        setTimeout(() => {
          i(o.content, o)
        }, e.delay || 0)
    }
  ...
  dismissCallback(e) {
    ...
    const t = (a = e.currentTarget) == null ? void 0 : a.id,
      n = document.getElementById(t)
    n &&
      (n.removeEventListener('animationend', C.dismissCallback, false),
      setTimeout(() => {
        C.remove(t)
      }))
  },
    ...
    if (e) {
      ...
      for (const n of t)
        if (n.toastId === e) {
          ...
          a &&
            (a.remove(),
            a.removeEventListener('animationend', C.dismissCallback, false),
            C.remove(e))
          break
        }
    }
...
var We = defineComponent({
  ...
  setup(e, { attrs: t }) {
    const n = ref(),
      ...
      s = computed(() =>
        [
          ''.concat(r.CSS_NAMESPACE, '__progress-bar'),
          e.controlledProgress
            ? ''.concat(r.CSS_NAMESPACE, '__progress-bar--controlled')
            : ''.concat(r.CSS_NAMESPACE, '__progress-bar--animated'),
          ''.concat(r.CSS_NAMESPACE, '__progress-bar-theme--').concat(e.theme),
          ''.concat(r.CSS_NAMESPACE, '__progress-bar--').concat(e.type),
          e.rtl ? ''.concat(r.CSS_NAMESPACE, '__progress-bar--rtl') : null
        ]
          .filter(Boolean)
          .join(' ')
      ),
      d = computed(() => ''.concat(s.value, ' ').concat((t == null ? void 0 : t.class) || '')),
      T = () => {
      ...
      N = computed(() => (e.controlledProgress ? null : u)),
      m = computed(() => (e.controlledProgress ? u : null))
    return (
      watchEffect(() => {
  ...
  setup(e) {
    return () =>
      createVNode(
        ...
        {
          class: ''
            .concat(r.CSS_NAMESPACE, '__close-button ')
            .concat(r.CSS_NAMESPACE, '__close-button--')
            .concat(e.theme),
          type: 'button',
          onClick: (t) => {
...
var tt = (e) => e in oe
function nt({ theme: e, type: t, isLoading: n, icon: a }) {
  let o
  const s = {
    theme: e,
    type: t
...
function st(e) {
  const t = ref(false),
    ...
    d = s.done || at,
    T = computed(() => (s.appendPosition ? ''.concat(s.enter, '--').concat(s.position) : s.enter)),
    u = computed(() => (s.appendPosition ? ''.concat(s.exit, '--').concat(s.position) : s.exit)),
    N = computed(() =>
      e.pauseOnHover
        ? {
            onMouseenter: h2,
  ...
  function m() {
    ...
    E().addEventListener(J.ENTRANCE_ANIMATION_END, p, { once: true })
    const O = ($) => {
        const U = E()
        $.target === U &&
          (U.dispatchEvent(new Event(J.ENTRANCE_ANIMATION_END)),
          U.removeEventListener('animationend', O),
          U.removeEventListener('animationcancel', O),
          o.value === V.Enter && $.type !== 'animationcancel' && U.classList.remove(...y))
      },
      b = () => {
        const $ = E()
        $.classList.add(...y),
          $.addEventListener('animationend', O),
          $.addEventListener('animationcancel', O)
      }
  ...
  function S() {
    ...
    const y = () => {
      ...
      O = () => {
        const b = E()
        ;(o.value = V.Exit),
          b && ((b.className += ' '.concat(u.value)), b.addEventListener('animationend', y))
      }
...
var rt = defineComponent({
  ...
  setup(e) {
    const t = ref(),
      n = computed(() => !!e.isLoading),
      a = computed(() => e.progress !== void 0 && e.progress !== null),
      o = computed(() => nt(e)),
      s = computed(() =>
        [
          ''.concat(r.CSS_NAMESPACE, '__toast'),
          ''.concat(r.CSS_NAMESPACE, '__toast-theme--').concat(e.theme),
          ''.concat(r.CSS_NAMESPACE, '__toast--').concat(e.type),
          e.rtl ? ''.concat(r.CSS_NAMESPACE, '__toast--rtl') : void 0,
          e.toastClassName || ''
        ]
          .filter(Boolean)
          .join(' ')
    ...
    return () =>
      createVNode(
        ...
        [
              ...
              o.value != null &&
                createVNode(
                  'div',
                  {
                    ...
                    class: [
                      ''.concat(r.CSS_NAMESPACE, '__toast-icon'),
                      e.isLoading
                        ? ''
                        : ''
                            .concat(r.CSS_NAMESPACE, '--animate-icon ')
                            .concat(r.CSS_NAMESPACE, '__zoom-enter')
                    ].join(' ')
                  },
                  [
                    G(o.value)
          ...
          (e.closeButton === void 0 || e.closeButton === true) &&
            createVNode(
              Ke,
              {
                theme: e.theme,
...
function Se() {
  typeof window > 'u' ||
    ...
    (x = window.requestAnimationFrame(Se)),
    Q.lastUrl !== window.location.href && ((Q.lastUrl = window.location.href), C.clear()))
}
var it = defineComponent({
  ...
  // @ts-ignore
  setup(e) {
    const t = computed(() => e.containerId),
      n = computed(() => c[t.value] || []),
      a = computed(() => n.value.filter((o) => o.position === e.position))
    return (
      onMounted(() => {
...
function L(e, t, n = {}) {
  ...
  ;(n = Y(
    ...
    (!n.toastId || (typeof n.toastId != 'string' && typeof n.toastId != 'number')) &&
      (n.toastId = ye()),
    (n = {
      ...n,
      content: e,
  ...
  return (
    a < 0 && (n.progress = 0),
    a > 1 && (n.progress = 1),
    n.theme === 'auto' && (n.theme = Ve()),
    dt(n),
    (Q.lastUrl = window.location.href),
    n.multiple
      ? _.items.length
        ? n.updateId && j(e, n)
        : j(e, n)
      : ((X = true),
        i.clearAll(void 0, false),
        setTimeout(() => {
          j(e, n)
        }, 0),
        setTimeout(() => {
...
i.promise = ut
function ut(e, { pending: t, error: n, success: a }, o) {
  var m, S, E
  let s
  const d = {
    ...(o || {}),
